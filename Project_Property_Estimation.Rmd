...
home_city_cleaned_dta<-map(home_city_dta,drop.missing)
home_city_cleaned_dta<-map(home_city_cleaned_dta,drop.unary)
...
home_county_cleaned_dta<-map(home_county_cleaned_dta,drop.unary)
```
